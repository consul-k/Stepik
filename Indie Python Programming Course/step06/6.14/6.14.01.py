...
Ваша задача на основании создать список кортежей words_with_position, каждый элемент-кортеж должен содержать два значения: 
...
words_with_position = [(v,i) for i,v in enumerate(words, start=1)]
