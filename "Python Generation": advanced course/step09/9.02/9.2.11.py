...
Далее идёт m блоков строк, описывающих листки с фамилиями. На первой строке каждого блока указано количество фамилий ni​, 
затем идёт ni​ строчек с фамилиями тех, кто был на i-ом уроке.
