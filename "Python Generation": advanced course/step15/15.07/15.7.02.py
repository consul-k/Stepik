...
Примечание 1. Тестирующая система никак не "покарает" вас за неиспользование встроенных функций filter(), map(), sorted() и reduce(), 
...
towns = list(filter(lambda city: city[1]>10000000 and city[2]=='primary', data))
towns1 = list(map(lambda city: city[0], towns))
towns1 = sorted(towns1)
print('Cities:',reduce(lambda x, y: x+', '+y, towns1))
