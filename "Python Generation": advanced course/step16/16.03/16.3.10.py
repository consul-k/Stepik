...
Переводим его в верхний регистр BASIS. Для каждого символа в слове находим его код с помощью встроенной функции ord():
...
words = sorted(words)
words = sorted(words, key = lambda x: gem(x))
for word in words:
    print(word)
