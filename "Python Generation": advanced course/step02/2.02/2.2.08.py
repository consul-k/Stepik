...
tim_choice = input()
rus_choice = input()
if tim_choice == rus_choice:
    print('ничья')
elif (tim_choice == 'камень' and rus_choice == 'ножницы') or (tim_choice == 'ножницы' and rus_choice == 'бумага') or (tim_choice == 'бумага' and rus_choice == 'камень') or (tim_choice == 'камень' and rus_choice == 'ящерица') or (tim_choice == 'ящерица' and rus_choice == 'Спок') or (tim_choice == 'Спок' and rus_choice == 'ножницы') or (tim_choice == 'ножницы' and rus_choice == 'ящерица') or (tim_choice == 'ящерица' and rus_choice == 'бумага') or (tim_choice == 'бумага' and rus_choice == 'Спок') or (tim_choice == 'Спок' and rus_choice == 'камень'):
    print('Тимур')
else:
    print('Руслан')
