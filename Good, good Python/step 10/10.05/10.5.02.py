...
match book:
    case (_,author, title) if len(author) >= 6 and len(title) >= 10:
        print('Yes')
    case (_,author, title, float() | int() as price) if len(author) >= 6 and price > 0:
        print('Yes')
    case (_,author, title, int() as year) if year >= 2020:
        print('Yes')    
    case (_,author, title, float() | int() as price, int() as year) if price > 0 and year >= 2020:
        print('Yes')
    case _:
        print("No")
