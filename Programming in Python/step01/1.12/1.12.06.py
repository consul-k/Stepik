...
что вы не рассмотрели какой-то из случаев входных данных (число программистов 0≤n≤10000≤n≤1000). 
...
if a % 100 == 11 or a % 100 == 12 or a % 100 == 13 or a % 100 == 14:
    ...
    if a % 10 == 0 or a % 10 == 5 or a % 10 == 6 or a % 10 == 7 or a % 10 == 7 or a % 10 == 8 or a % 10 == 9:
        print(a, "программистов")
    if a % 10 == 1:
        print(a, "программист")
